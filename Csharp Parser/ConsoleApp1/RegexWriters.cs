...
namespace ConsoleApp1
{
    ...
    {
        public RegexWriters(string fileLocation = @"C:\Users\Gebruiker\Downloads\Writers.list", string newFileName = @"..\..\..\testfiles\editedwriterstest.csv") : base(fileLocation, newFileName)
        {
